...
## EGRIN**2.0**-tools - Utilities and scripts for generating EGRIN**2.0** ensembles using [cMonkey2-python biclustering algorithm](https://github.com/baliga-lab/cmonkey2/)
