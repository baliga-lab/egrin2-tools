...
def create_tables(conn):
    ...
    conn.execute('create table if not exists fimo (motif_info_id int, strand text, start int, stop int, score decimal, pvalue decimal, in_coding_rgn text, mo_scaffold_id int)')
